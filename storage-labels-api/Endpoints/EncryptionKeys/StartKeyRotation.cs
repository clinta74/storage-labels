...
{
    private static async Task<Results<Accepted<Guid>, ProblemHttpResult>> StartKeyRotation(StartRotationRequest request, HttpContext context, [FromServices] IKeyRotationService rotationService, [FromServices] ILogger<EncryptionKeyEndpoints> logger, CancellationToken cancellationToken)
    {

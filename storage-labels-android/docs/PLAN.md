...
**Status:** Phase 0 underway. The project scaffold, containerised build and CI workflow exist and produce a debug APK; no product features yet. See [../README.md](../README.md) to build it.

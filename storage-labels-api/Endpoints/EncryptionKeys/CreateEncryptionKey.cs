...
{
    private static async Task<Results<Ok<EncryptionKeyResponse>, ProblemHttpResult>> CreateEncryptionKey(CreateEncryptionKeyRequest request, HttpContext context, [FromServices] IImageEncryptionService encryptionService, [FromServices] ILogger logger, CancellationToken cancellationToken)
    {
